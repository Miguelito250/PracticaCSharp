...
namespace TiendaMiguel.Controllers
{
    [Authorize]
    public class DetallesVentasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DetalleVentaId,VentaId,ProductoId,Cantidad,Valor")] DetallesVenta detallesVenta)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewData["Mensaje"] = "La cantidad de productos es mayor a los existentes, cuentas con " + producto.Cantidad + "de" + producto.Nombre;
                }
            }
            ViewData["IdProductoF"] = new SelectList(_context.Productos, "IdProducto", "NombreProducto", detallesVenta.ProductoId);
